...
class AppTextStyles {
  ...
  static const TextStyle normal22 =  TextStyle(fontSize: 22.0, fontWeight: FontWeight.normal);
  static const TextStyle bold22 =  TextStyle(fontSize: 22.0, fontWeight: FontWeight.bold);
  static const TextStyle italic22 =  TextStyle(fontSize: 22.0, fontStyle: FontStyle.italic);
  static const TextStyle boldItalic22 =
  TextStyle(fontSize: 22.0, fontWeight: FontWeight.bold, fontStyle: FontStyle.italic);
